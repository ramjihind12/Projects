	...
	<form action="" method="post">
		...
		<fieldset>
			<legend>Personal Details:</legend>
				...
				<input class="inp-text" name="input-one-name" value="Ramji" id="input-one" type="text" size="30" /><br />

				<label for="Age" class="float"><strong>Age :</strong></label><br />
				<input class="inp-text" name="input-two-name" value="22"  id="input-two" type="text" size="30" /><br />
				...
				<input class="inp-text" name="input-four-name" value="9.1" id="input-four" type="text" size="30" />
		...
		<!-- ============================== Fieldset 1 end ============================== -->
                ...
                <div class=image>
                <img src="dataSet/User.1.18.jpg" alt="autumn" width="200" height="140" >
		</div>
